...
const transformedErrorMessages: Partial<
	Record< DegreeProgramDataPaths, string >
> = {
	'featured_image.id': __(
...
> = {
	...
	rest_too_short_en: __(
		'English variant of this field can not be empty.',
		'fau-degree-program'
	),
	rest_too_few_items: __(
		'Please select at least one item.',
		'fau-degree-program'
	),
	rest_invalid_pattern: __(
